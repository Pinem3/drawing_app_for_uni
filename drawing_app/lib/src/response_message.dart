...
class GetAllUsersResponse extends ResponseMessage {
  ...
  GetAllUsersResponse(
    this.users, {super.type = ResponseType.all,}
  );
  ...
  factory GetAllUsersResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (usersResponse.isNotEmpty) {
      return GetAllUsersResponse(usersResponse.map((e) => User.fromJson(e)).toList());
    }
...
class GetUserResponse extends ResponseMessage {
  ...
  GetUserResponse(this.user, {super.type = ResponseType.get});
...
class OperationResponse extends ResponseMessage {
  final bool success;
  OperationResponse(this.success, {super.type = ResponseType.success});
  ...
  @override
  Map<String, dynamic> toJson() {
    return{'type': type.name, 'success': success};
  }
}